...
If the language doesn't provide a way to get the length of an array or vector from their underlying representation, it is recommended to implement the ability to get length of an array/vector in the [`introspection`](pathname:///ref/introspection) module.
