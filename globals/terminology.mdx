...
An element must belong to one version of a module. The scheme for element identifiers is `<module-scheme>/<elementName>`, in which `<elementName>` matches `^[a-z_][a-z0-9_]*$`.
