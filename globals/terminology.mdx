...
Refers to a concrete, coherent realization of OBGX interfaces through which packs use OBGX within a host. An implementation may use one or more programming languages, declarative languages, or data formats.
...
(Or **content pack**) refers to a collection of interface usage code and static assets that can interact with one or more implementations of a host that correctly implements the OBGX modules used by the pack.
